...
import static GamePackage.SoundManager.*;
...
public class Game extends Model  {
    ...
    public void update(){
        ...
        for (GameObject g : gameObjects) {
            ...
            if (g.isDead()){
                ...
                if(g.objectType != GameObject.PLAYER_OBJECT){
                    if (shipJustAdded) {
    ...
    private GameObject moveObjectAwayFromShip(GameObject o){
        ...
        if (!ship.isDead()) { //obtains ship location if the ship isn't dead
            ...
            vecFromShip = MIDDLE_VECTOR.getVectorTo(o.getPosition(), FRAME_WIDTH, FRAME_HEIGHT);
        }
