...
import GamePackage.Controllers.EnemyController;
...
public class EnemyShip extends Ship {
    ...
    public EnemyShip(Model m){
        super(
                ...
                Vector2D.polar((Math.random() * Math.PI * 2) - Math.PI, 0),
                Vector2D.polar((Math.random() * Math.PI * 2) - Math.PI, 1),
                new EnemyController(m)
        );
