...
public class SoundManager {
    ...
    //private final static Clip[] clips = {andYouFailed,bweb,bwoab,nice,clap,crunch,intimidating, hum,longCrunch,menuTheme,mediumCrunch,ohno,solidHit,explosion,yerDead,gameTheme};
